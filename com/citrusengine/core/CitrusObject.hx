...
class CitrusObject {
	...
	function setParams(object : Dynamic) : Void {
		for(var param : String in Reflect.fields(object)) {
			try {
				if(object[param] == "true") this[param] = true
				else if(object[param] == "false") this[param] = false
				else this[param] = object[param];
			}
			catch(e : Error) {
